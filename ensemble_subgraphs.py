...
def ensemble_partial_sim_matrix(data_set, svm=False, device='cpu'):
    ...
    model_name_list = ['Literal', 'Structure', 'Digital']
...
if __name__ == '__main__':
    ...
    # default_dataset = project_root + '/bin/DBP15k/fr_en'  # DBP15k, DWY100k  # wd_dbp, yg_dbp
    ...
    if args.dataset.find('DBP15k') >= 0:
        train_sims, valid_sims, test_sims = load_sim_matrices(args.dataset,
                                                              # ['Structure'],
                                                              ['Structure', 'Test', 'Time'],
                                                              # ['Structure', 'Literal', 'Digital', 'Name', 'Time'],
